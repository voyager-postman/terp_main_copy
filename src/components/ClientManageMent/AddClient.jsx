...
const AddClient = () => {
	...
	const AddClient = () => {
		...
		axios
			.post(`${API_BASE_URL}/addClient`, request)
			.then((response) => {
		...
		<>
			<div className="bg-gray-100 mx-4 my-10 shadow-md shadow-gray-700/40 hover:shadow-gray-900/40">
				...
				<div className="grid grid-cols-1 mx-4 my-4">
					<label
						htmlFor="message"
						className="block mb-2 text-sm font-bold text-gray-900 dark:text-white uppercase"
					>
						Address :
					</label>
					<textarea
				...
				<label
					...
					className="block mx-4 font-bold mb-2 text-sm text-gray-900 dark:text-white uppercase"
				>
					Bank Information :
				</label>
