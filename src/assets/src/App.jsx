...
import PriceCheck from "./components/Orders/PriceCheck";
import UpdatePriceCheck from "./components/Orders/UpdatePriceCheck";
          ...
          <Routes>
            {isAuthenticate ? (
              <Route element={<PrivateRoute isAuthenticate={isAuthenticate} />}>
                ...
                <Route path="/update_price_check" element={<UpdatePriceCheck />} />
