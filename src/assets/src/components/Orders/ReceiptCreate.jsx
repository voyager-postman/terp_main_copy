...
const ReceiptCreate = () => {
  ...
  // Prevent crash if modalHead or modalData are undefined
  const paymentAmountKey = modalHead
    ? Object.keys(modalHead).find((key) => modalHead[key] === "Payment Amount")
    : null;

  const paymentAmountValue =
    paymentAmountKey && modalData
      ? modalData[paymentAmountKey]
      : 0;
                    ...
                    <div className=" col-xl-3 col-lg-3 col-md-4">
                      <div className="parentFormPayment">
                        ...
                        <input
                          type="text"
                          value={
                            paymentForm.paymentAmount || paymentAmountValue
                          }
                          onChange={(e) =>
