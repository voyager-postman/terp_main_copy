      ...
      <Card title={t("orderPacking")}>
        ...
        >
          ...
          <div className="row formEan">
                <div className="col-lg-3 form-group">
                   <div className="parentPurchaseView">
                    ...
                    <div className="parentPurchaseView">
                      ...
                      <div>
                        <p>{from?.load_date ? new Date(from.load_date).toLocaleDateString() : ""}</p>
                      </div>
                    </div>
                    <div className="parentPurchaseView">
                      <div className="me-3">
              ...
              <div
                id="datatable_wrapper"
                className=" mt-3 orderPackingEdit information_dataTables dataTables_wrapper dt-bootstrap4 table-responsive mt-"
              >
                <table
                  id="example"
