...
const UpdatePriceCheck = () => {
  ...
  return (
    <>
      <Card title={`${t("priceCheckManagement")} / ${t("updateForm")}`}>
                          ...
                          <div>
                            <p>
                              {computedState.load_date
                                ? new Date(computedState.load_date).toLocaleDateString("en-GB")
                                : "No date selected"}
                            </p>
                          </div>
                        </div>
                          ...
                          <div>
                            <p>
                              ...
                              {clients
                                ...
                                .find((client) => client.id === state.client_id)
                                ?.name || ""}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="parentPurchaseView">
                          ...
                          <div>
                            <p>
                              ...
                              )?.Name_EN || "No brand selected"}
                            </p>
                          </div>
                        </div>
                        <div className="parentPurchaseView">
                          <div className="me-3">
                            <strong>{t("portOfOrigins")} : </strong>
                          </div>
                          <div>
                            <p>
                              {" "}
                        ...
                        <div className="parentPurchaseView">
                          ...
                          <div>
                            <p>
                              ...
                              )?.FX || "No currency selected"}
                            </p>
                          </div>
                        </div>
                        <div className="parentPurchaseView">
                          <div className="me-3">
                            <strong>{t("markupRate")} : </strong>
                          </div>
                          <div>
                            <p>{computedState.mark_up || 0}%</p>
                          </div>
                        </div>
                        <div className="parentPurchaseView">
                          <div className="me-3">
                          ...
                          <div>
                            <p>{computedState.fx_rate || 0}</p>
                          </div>
                        </div>
                        <div className="parentPurchaseView">
                          <div className="me-3">
                            <strong>{t("rebate")} :</strong>
                          </div>
                          <div>
                            <p>{computedState.rebate || 0}%</p>
                          </div>
                        </div>
                      </div>
                      <div className="col-lg-4">
                        ...
                        <div className="parentPurchaseView">
                          <div className="me-3">
                            <strong>{t("portOfDestination")} : </strong>
                          </div>
                          <div>
                            <p>
                              {ports?.find(
                        ...
                        <div className="parentPurchaseView">
                          ...
                          <div>
                            <p>
                              ...
                              )?.name || "No clearance provider selected"}
                            </p>
                          </div>
                        </div>
                        <div className="parentPurchaseView">
                          ...
                          <div>
                            <p>
                              ...
                              )?.name || "No freight provider selected"}
                            </p>
                          </div>
                        </div>
                      </div>
