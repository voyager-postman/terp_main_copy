  ...
  const uploadPDF5 = async (pdfBlob, a) => {
    ...
    try {
      ...
      if (response.data.success) {
        console.log("PDF uploaded successfully");
        window.open(
          `${API_IMAGE_URL}${a?.Order_Number || "default"
    ...
    try {
      ...
      const addLogoWithDetails = async () => {
        ...
        const textDataLeft = [
          ...
          {
            label: "AWB :",
            value: `${deliveryApi?.data?.result?.bl ? deliveryApi?.data?.result?.bl : ""
              }`,
          },
        ];
        ...
        const textDataRight = [
          ...
          {
            label: "Ship Date :",
            value: `${deliveryApi?.data?.orderDetails[0]?.Ship_date
          ...
          {
            label: "Delivery By :",
            value: `${deliveryApi?.data?.orderDetails[0]?.journey_number
