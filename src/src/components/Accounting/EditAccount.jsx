...
const UpdateAccounts = () => {
  ...
  useEffect(() => {
    setFormData({
      ...
      account_lvl1: from.account_lvl1 || "",
      account_lvl2: from.account_lvl2 || "",
      account_lvl3: from.account_lvl3 || "",
      account_lvl4: from.account_lvl4 || "",
      type_name_en: from.type_name_en || "",
      type_name_th: from.type_name_th || "",
    });
  }, [from]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${API_BASE_URL}/updateChartOfAccount`,
        {
          accounting_id: from.accounting_id,
      ...
      <div className="bg-white rounded border">
        <div className="grayBgColor px-4 py-3 rounded-t">
          <div className="flex justify-between items-center exportPopupBtn">
            <h6 className="font-weight-bolder mb-0">Accounts / Update Form</h6>
          </div>
        </div>
