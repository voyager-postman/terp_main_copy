...
const CreateTest = () => {
  ...
  //     })
  //     .then((res) => {
  //       const detail = res.data.detailRow1 || null;----
  //       setOrderIdData(res.data.detailRow1.Order_ID);
  ...
  useEffect(() => {
    ...
    axios
      .post(`${API_BASE_URL}/ConsigneeDropDown`, { Client_id: state.client_id })
      .then((res) => {
        setConsigneesNew(res.data.data1 || []);
      })
      .catch(console.error);
  }, [state.client_id]);
